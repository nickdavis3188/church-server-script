...
// 	}
	...
	// for (let i = 0; i < iu.length;i++){
		// let ress = iu[i]
		// for(k in iu[i]){
			// if(iu[i][k].JourneyId.JourneyPriority == 1){
				// arrr.push(iu[i][k].JourneyId.JourneyPriority)
			// }
			// console.log(iu[i][k].JourneyId.JourneyPriority)
		// }
...
console.log(new Date("2021-09-24T06:34:22.462Z").getMonth()+1)//"2021-09-19T19:14:09.993Z"
