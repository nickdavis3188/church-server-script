...
const dashboradFilter = (yearFilterdData,selectedYear)=>{
	...
	const femaleJan = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==1)
	const femaleFeb = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==2)
	const femaleMac = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==3)
	const femaleApl = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==4)
	const femaleMy = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==5)
	const femaleJn = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==6)
	const femaleJl = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==7)
	const femaleAug = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==8)
	const femaleSep = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==9)
	const femaleOct = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==10)
	const femaleNov = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==11)
	const femaleDec = yearFilterdData.filter((e)=> e.Sex =='Female' || e.Sex =='female').filter((e)=> e.monthCreated ==12)
	
	//male
	const maleJan = yearFilterdData.filter((e)=> e.Sex =='Male'|| e.Sex =='male').filter((e)=> e.monthCreated ==1)
	const maleFeb = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==2)
	const maleMac = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==3)
	const maleApl = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==4)
	const maleMy = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==5)
	const maleJn = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==6)
	const maleJl = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==7)
	const maleAug = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==8)
	const maleSep = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==9)
	const maleOct = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==10)
	const maleNov = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==11)
	const maleDec = yearFilterdData.filter((e)=> e.Sex =='Male' || e.Sex =='male').filter((e)=> e.monthCreated ==12)
